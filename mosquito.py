...
# load flyswatter image，64px * 64px
flyswatter_image = pygame.image.load('./images/flyswatter.png')  
...
class Mosquito(pygame.sprite.Sprite):
    def __init__(self, width, height, random_x, random_y, widow_width, window_height):
        super().__init__()
        self.raw_image = pygame.image.load('./images/mosquito.png').convert_alpha()
...
def main():
    ...
    while True:
        ...
        screen.blit(flyswatter_image, (x -32, y - 32))
